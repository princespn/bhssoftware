        ...
        while (($row = fgetcsv($handle)) !== FALSE) {
            ...
            if (!empty($id)) {
                ...
                if ((!empty($pcodes))) {
                    ...
                    if(((!empty($WebListConfig['web_sale_price_uk'])) && (!empty($WebConfig['web_sale_price_uk']))) && (($WebConfig['web_sale_price_uk'])!==($WebListConfig['web_sale_price_uk']))) {
                    ...
                    if(((!empty($WebListConfig['web_sale_price_tesco'])) && (!empty($WebConfig['web_sale_price_uk']))) && (($WebConfig['web_sale_price_uk'])!==($WebListConfig['web_sale_price_tesco']))) {
                    ...
                    if(((strpos($apiConfig['amazon_sku'], 'FBA') === false) && (!empty($data['MainListing']['sale_price_uk'])) && (!empty($WebConfig['web_sale_price_uk']))) && (($WebConfig['web_sale_price_uk'])!==($data['MainListing']['sale_price_uk']))) {
                    ...
                    if(((strpos($apiConfig['amazon_sku'], 'FBA') !== false) && (!empty($data['MainListing']['sale_price_uk'])) && (!empty($WebListConfig['web_sale_price_dm']))) && (($WebListConfig['web_sale_price_dm'])!==($data['MainListing']['sale_price_uk']))) {
                    ...
                    if(((strpos($apiConfig['amazon_sku'], 'FBA') === false) && (!empty($data['MainListing']['sale_price_de'])) && (!empty($WebConfig['web_sale_price_de']))) && (($WebConfig['web_sale_price_de'])!==($data['MainListing']['sale_price_de']))) {
                    ...
                    if(((strpos($apiConfig['amazon_sku'], 'FBA') === false) && (!empty($data['MainListing']['sale_price_fr'])) && (!empty($WebConfig['web_sale_price_fr']))) && (($WebConfig['web_sale_price_fr'])!==($data['MainListing']['sale_price_fr']))) {
