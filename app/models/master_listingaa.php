...
class MasterListing extends AppModel {
    ...
    public function deletecode($filename)
    {
        ...
        while (($row = fgetcsv($handle)) !== FALSE) {
            ...
            if (!empty($id)) {
                ...
                if (((!empty($id)) && (empty($pcodes[0]['MasterListing']['sale_price_fr'])) && (empty($pcodes[0]['MasterListing']['sale_price_de']))) && ($id === $pcodes[0]['MasterListing']['amazon_sku'])) {
                ...
                if ((!empty($id)) && (!empty($newsku)) && ($id === $pcodes[0]['MasterListing']['amazon_sku'])) {
