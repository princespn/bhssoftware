...
class GermanListing extends AppModel {
                        ...
                        {	
                            ...
                            if (!empty($listings))
                            {
                                ...
                                $data['GermanListing'] = array_merge($apiConfig,$data['GermanListing']);
                                    if((!empty($apiConfig['standard_price'])) && ($apiConfig['standard_price']!= $data['GermanListing']['standard_price']))
                                    {
                                    $err = '';
            ...
            var $hasOne = array(
                ...
                'foreignKey' => false,
                'conditions' =>  'GermanListing.item_sku = InventoryMaster.item_sku'
                ),
            );
