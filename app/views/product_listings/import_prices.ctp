...
<div class="imports form">
    <div class="grid_16">
        <h2 id="page-heading"><?php __('Import Price compare Inventory');?></h2>
<?php 
echo $this->Form->create('ProductListing',array('action' => 'import_prices','enctype'=>'multipart/form-data'));?>
        <fieldset>
            <legend><?php __('Import Price  Listings'); ?></legend>
<?php
echo $this->Form->input('file', array('label'=>'Import Price  Listings','type'=>'file') );
...
?> 
        ...
        <div class='submit'>
<?php 
echo $this->Form->button('Import Price Listing', array('id'=>'submit','disabled'=>'disabled','type'=>'submit'));
?>
        </div>
<?php
echo $this->Form->end();?>
