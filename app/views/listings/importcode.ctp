...
<h1 class="sub-header"><?php __('Website Prices Inventory');?></h1>
<hr>

 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Website Prices Inventory');?></h3>
      </div>
      <div class="panel-body">
        <?php echo $this->Form->create('Listing',array('action' => 'importcode','enctype'=>'multipart/form-data'));?>
