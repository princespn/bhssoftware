...
<?php 
echo $this->Form->create('EbayenglishListing',array('action' => 'import','enctype'=>'multipart/form-data'));?>
	<fieldset>
		<legend><?php __('Import Ebay UK Listing'); ?></legend>
		<?php
		echo $this->Form->input('file', array('label'=>'Import Ebay UK Listing','type'=>'file') );
