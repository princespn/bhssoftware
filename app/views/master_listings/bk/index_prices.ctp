...
$line = $code_listings[0]['MasterListing'];
...
$line = $code_listing['MasterListing'];
...
<?php echo $this->Session->flash(); ?>
 <hr>
<h1 class="sub-header"><?php __('Master Amazon Prices Listing');?> </h1>
<?php  echo $form->create('MasterListing',array('action'=>'index_prices','id'=>'saveForm')); ?>
    ...
    <table class="table table-bordered table-striped table-hover">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php echo $code_listing['MasterListing']['price_de']; ?></td>
