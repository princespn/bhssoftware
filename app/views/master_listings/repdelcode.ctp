...
<h1 class="sub-header"><?php __('Master Amazon Replace or Delete Amazon SKU');?></h1>
<hr>
 ...
 <div class="panel panel-info import-panel">
      ...
      <div class="panel-body">
        <?php echo $this->Form->create('MasterListing',array('action' => 'repdelcode','enctype'=>'multipart/form-data'));?>
...
$(document).ready(function(){
	$('#MasterListingFile').change(function(){
