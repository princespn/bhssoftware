...
<div class="panel panel-default">
	...
	<div class="table-responsive">
	   ...
	   <?php endforeach; ?>
	   <tr><td colspan="2"><strong>Total Orders</strong></td><td><?php echo ($curweek1+$curweek2); ?></td><td><?php echo ($prevweek1+$prevweek2); ?></td><td><?php echo ($lastweek1+$lastweek2); ?></td><td><?php echo ($currmonth1+$currmonth2); ?></td><td><?php echo ($pastmonth1+$pastmonth2); ?></td><td><?php echo ($lastmonth1+$lastmonth2); ?></td><td><?php echo ($currytd1+$currytd2); ?></td><td><?php echo ($lastytd1+$lastytd2); ?></td><td><?php echo ($lastyear1+$lastyear2); ?></td></tr>
		</table>
		</div>