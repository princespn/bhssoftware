...
<?php  //print_r($query_date); die(); ?>
  ...
  <div class="table-responsive">
   ...
   <table id="table-1" class="table table-bordered table-striped table-hover">
        <thead><tr><td width="100px"><strong><?php __('Category name');?></strong></td>		
		<?php $i = 0; $len = count($query_date); foreach($query_date as $firstandlast){  $yrdata = strtotime($firstandlast);   if ($i == $len - 1){ }else {?><td><table class="table table-bordered table-striped table-hover"><tr><td width="100px" colspan="2"><strong><?php echo date('M-Y', $yrdata); $i++; ?></strong></td></tr>
		   ...
		   <?php $Totalnumbsumeur2 = array(); $Totalnumbsumegbp2 = array();  $Totalordersumeur2 = array();  $Totalordersumegbp2 = array(); ?>
			...
			<?php if($currentsweek10['ProcessedListing']['currency'] ==='EUR'){ $Totalnumbsumeur12[] = $currentsweek10[0]['orderid']; $Totalordersumeur12[] = $currentsweek10[0]['ordervalues']*0.84;}else if($currentsweek10['ProcessedListing']['currency'] ==='GBP'){ $Totalnumbsumegbp12[] = $currentsweek10[0]['orderid'];  $Totalordersumegbp12[] = $currentsweek10[0]['ordervalues'];} ?>
            <?php   } ?>
            <?php endforeach; ?>
			...
			<?php if($currentsweek13['ProcessedListing']['currency'] ==='EUR'){ $Totalnumbsumeur13[] = $currentsweek13[0]['orderid']; $Totalordersumeur13[] = $currentsweek13[0]['ordervalues']*0.84;}else if($currentsweek13['ProcessedListing']['currency'] ==='GBP'){ $Totalnumbsumegbp13[] = $currentsweek13[0]['orderid'];  $Totalordersumegbp13[] = $currentsweek13[0]['ordervalues'];} ?>
            <?php   } ?>
            <?php endforeach; ?>
        ...
        <div class="rTableHeading"><div class="rTableHead"><?php __('Sales Platform');?></div>
         ...
         <?php $a = $b; ?>
           ...
           <?php endforeach; ?>							 
            ...
            <?php if((!empty($currentvalueeur13[0])) && ($currentcurreur13[0]==='EUR')){ $currvaluemain13 = $currentvalueeur13[0]*0.84;  echo "<div class='rTableCell'>". round($currvaluemain13,2) ."</div>"; } else if((!empty($currentvaluegbp13[0])) && ($currentcurrgbp13[0]==='GBP')){ echo "<div class='rTableCell'>". round($currentvaluegbp13[0],2) ."</div>"; } else { echo "<div class='rTableCell'>-</div>"; } ?>
            <?php } ?>				
