...
echo $this->Session->flash(); ?>
 <hr>
<?php //print_r($Catpreviousweeks);die();
...
?>
  <h1 class="sub-header"><?php __('Sales Per-Category Weekly Orders Reports');?></h1>
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-striped table-hover">
        <tr id="head-table"> 
            ...
            <th colspan="4" class="text-center text-uppercase color-black green-bg"><?php __('Current Week');?><?php echo "( ".$this_week_sd." - To - ".$this_week_ed." )"; ?></th>
        
            <th  colspan="5" class="text-center text-uppercase color-black yellow-bg"><?php __('Previous Week');?><?php echo "( ".$start_week." - To - ".$end_week." )"; ?></th>
       ...
       <tr><td class='width55' colspan="3"><?php __('Category');?></td><td><?php __('No of Orders');?></td><td><?php __('Currency');?></td><td><?php __('Order Value');?></td><td><?php __('No of Orders');?></td><td><?php __('Order Progress');?></td><td><?php __('Currency');?></td><td><?php __('Order value');?></td><td><?php __('Value Progress');?></td><td><?php __('No of Orders');?></td><td><?php __('Order Progress');?></td><td><?php __('Currency');?></td><td><?php __('Order value');?></td><td><?php __('Value Progress');?></td></tr>
        <?php    $a = '0'; foreach ($CatSaveallweeks as $value): ?>  
        <?php $b = $value['ProcessedListing']['cat_name']; ?> 
        <?php  $numcurgbp = array();$ordercurgbp = array(); $numcureur = array(); $ordercureur = array(); foreach ($Countcurrenpweeks as $CatGbpweek): ?> 
        ...
        <?php  $numprevgbp = array();$orderprevgbp = array(); $numpreveur = array(); $orderpreveur = array();  foreach ($Countprevweeks as $Countprevweek): ?>       
        ...
        <?php  $numlastgbp = array();$orderlastgbp = array(); $numlasteur = array(); $orderlasteur = array();  foreach ($Countlastweeks as $Countlastweek): ?>       
        ...
        <?php if($a!==$b){ echo "<tr><td colspan='20'><div class='accordion sale-by-category'><table class='table-responsive category'><tr><td class='width33'><table class='table-responsive table-bordered'><tr><td colspan='3' rowspan='2' class='width33'>".$b."</td><td class='width15'>". $numcurgbp[0] ."</td><td class='width15'>GBP</td><td class='width15'>". round($ordercurgbp[0],2) ."</td></tr><tr><td>". $numcureur[0] ."</td><td>EUR</td><td>". round($ordercureur[0],2)  ."</td></tr></table></td><td class='width33'><table class='table-responsive table-bordered'><tr><td class='width20'>". $numprevgbp[0] ."</td>". $currnumprogress ."<td class='width20'>GBP</td><td class='width20'>". round($orderprevgbp[0],2) ."</td>". $curvaluegbpprog ."</tr><tr><td class='width20'>". $numpreveur[0] ."</td>". $cureurnumprogress ."<td class='width20'>EUR</td><td class='width20'>". round($orderpreveur[0],2) ."</td>". $curvalueeurprog ."</tr></table><td class='width33'><table class='table-responsive table-bordered'><tr><td class='width20'>". $numlastgbp[0] ."</td>". $lastgbpprog ."<td class='width20'>GBP</td><td class='width20'>". round($orderlastgbp[0],2) ."</td>". $lastvaluegbpprog ."</tr><tr><td class='width20'>". $numlasteur[0] ."</td>". $lasteurprog ."<td class='width20'>EUR</td><td class='width20'>". round($orderlasteur[0],2) ."</td>". $lastvalueeurprog ."</tr></table></tr></table></div>";} ?>
        ...
        <div class="rTableHeading"><div class="rTableHead"><?php __('Sales Platform');?></div>
           ...
           <div class="rTableRow"><div class="rTableCell"><?php echo $value['ProcessedListing']['plateform']; ?></div>
               <div class="rTableCell"><?php echo $value['ProcessedListing']['subsource']; ?></div>                                 
                                ...
                                <?php foreach ($Catcurrents as $currentweeks): ?>  
                                ...
                                <?php foreach ($Catpreviousweeks as $previousweeks): ?>  
                                ...
                                <?php foreach ($Catlastweeks  as $datalastweek): ?>  
