...
<div class="users index">
	...
	<tr style="background:#666666;">
			<th><dev class="title-text"><?php __('User name');?></div></th>
			<th><dev class="title-text"><?php __('Group');?></div></th>
			<th><dev class="title-text"><?php __('Email Address');?></div></th>
			<th><dev class="title-text"><?php __('Date Create');?></div></th>
