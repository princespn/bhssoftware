...
<?php echo $this->Form->create('FranceProductListing');?>
<fieldset>
<legend><?php __('Edit FR Master Listing'); ?></legend>
...
$wordlist = split ("\_", $this->data['FranceMasterListing']['item_sku']); 	
echo $this->Form->input('item_sku',array('readonly' => 'readonly','value'=>$this->data['FranceMasterListing']['item_sku']));		
echo $this->Form->input('external_product_id',array('type'=>'text','label' =>'External Product Id','value'=>$this->data['FranceMasterListing']['external_product_id']));
echo $this->Form->input('external_product_id_type',array('value'=>$this->data['FranceMasterListing']['external_product_id_type']));
if((($wordlist[1])!=='FBA') && (empty($this->data['FranceMasterListing']['item_name']))){echo $this->Form->input('item_name',array('value'=>$this->data['FranceMasterListing']['item_name'],'id'=>'sessionNum','maxLength'=>'500','class' =>'warning'));}elseif(strlen($this->data['FranceMasterListing']['item_name'])>'500'){echo $this->Form->input('item_name',array('value'=>$this->data['FranceMasterListing']['item_name'],'id'=>'sessionNum','maxLength'=>'500','class' =>'warning'));}else{echo $this->Form->input('item_name',array('value'=>$this->data['FranceMasterListing']['item_name'],'id'=>'sessionNum','maxLength'=>'500'));}
?><div class="text_errror">Number of chars: <span id="sessionNum_counter">500</span>&nbsp;&nbsp;&nbsp;<a href=""><?php echo "Title cheker"; ?></a></div>
<?php if((($wordlist[1])!=='FBA') && (empty($this->data['FranceMasterListing']['brand_name']))){echo $this->Form->input('brand_name',array('value'=>$this->data['FranceMasterListing']['brand_name'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('brand_name',array('value'=>$this->data['FranceMasterListing']['brand_name'],'readonly'=>'readonly'));}
if((($wordlist[1])!=='FBA') && (empty($this->data['FranceMasterListing']['manufacturer']))){echo $this->Form->input('manufacturer',array('value'=>$this->data['FranceMasterListing']['manufacturer'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('manufacturer',array('value'=>$this->data['FranceMasterListing']['manufacturer'],'readonly'=>'readonly'));}
...
echo $this->Form->input('currency',array('value'=>$this->data['FranceMasterListing']['currency']));
if((($wordlist[1])!=='FBA') && (empty($this->data['FranceMasterListing']['quantity']))){}else{echo $this->Form->input('quantity',array('value'=>$this->data['FranceMasterListing']['quantity']));}
echo $this->Form->input('item_package_quantity',array('value'=>$this->data['FranceMasterListing']['item_package_quantity']));
echo $this->Form->input('product_tax_code',array('value'=>$this->data['FranceMasterListing']['product_tax_code']));
echo $this->Form->input('merchant_release_date',array('value'=>$this->data['FranceMasterListing']['merchant_release_date']));
//echo $this->Form->input('sale_price',array('value'=>$this->data['FranceMasterListing']['sale_price'],'readonly'=>'readonly'));
if((($this->data['FranceMasterListing']['parent_child'])!=='parent') && (empty($this->data['FranceMasterListing']['sale_price']))){echo $this->Form->input('sale_price',array('value'=>$this->data['FranceMasterListing']['sale_price'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('sale_price',array('value'=>$this->data['FranceMasterListing']['sale_price'],'readonly'=>'readonly'));}
echo $this->Form->input('sale_from_date',array('value'=>$this->data['FranceMasterListing']['sale_from_date']));
echo $this->Form->input('sale_end_date',array('value'=>$this->data['FranceMasterListing']['sale_end_date']));
echo $this->Form->input('condition_type',array('value'=>$this->data['FranceMasterListing']['condition_type']));
echo $this->Form->input('condition_note',array('value'=>$this->data['FranceMasterListing']['condition_note']));
echo $this->Form->input('fulfillment_latency',array('value'=>$this->data['FranceMasterListing']['fulfillment_latency']));
echo $this->Form->input('restock_date',array('value'=>$this->data['FranceMasterListing']['restock_date']));
...
if((($wordlist[1])!=='FBA') && (empty($this->data['FranceMasterListing']['recommended_browse_nodes1']))){echo $this->Form->input('recommended_browse_nodes1',array('class'=>'warning'));}else{echo $this->Form->input('recommended_browse_nodes1');}
...
echo $this->Form->input('main_image_url',array('value'=>$this->data['FranceMasterListing']['main_image_url']));
echo $this->Form->input('swatch_image_url',array('value'=>$this->data['FranceMasterListing']['swatch_image_url']));
echo $this->Form->input('other_image_url2',array('value'=>$this->data['FranceMasterListing']['other_image_url2']));
echo $this->Form->input('other_image_url3',array('value'=>$this->data['FranceMasterListing']['other_image_url3']));
echo $this->Form->input('other_image_url4',array('value'=>$this->data['FranceMasterListing']['other_image_url4']));
echo $this->Form->input('other_image_url5',array('value'=>$this->data['FranceMasterListing']['other_image_url5']));
echo $this->Form->input('other_image_url6',array('value'=>$this->data['FranceMasterListing']['other_image_url6']));
echo $this->Form->input('other_image_url7',array('value'=>$this->data['FranceMasterListing']['other_image_url7']));
echo $this->Form->input('other_image_url8',array('value'=>$this->data['FranceMasterListing']['other_image_url8']));
echo $this->Form->input('parent_child',array('value'=>$this->data['FranceMasterListing']['parent_child']));
echo $this->Form->input('parent_sku',array('value'=>$this->data['FranceMasterListing']['parent_sku']));
echo $this->Form->input('relationship_type',array('value'=>$this->data['FranceMasterListing']['relationship_type']));
echo $this->Form->input('variation_theme',array('value'=>$this->data['FranceMasterListing']['variation_theme']));
echo $this->Form->input('color_name',array('value'=>$this->data['FranceMasterListing']['color_name']));
echo $this->Form->input('color_map',array('value'=>$this->data['FranceMasterListing']['color_map']));
echo $this->Form->input('size_name',array('value'=>$this->data['FranceMasterListing']['size_name']));
echo $this->Form->input('material_type1',array('value'=>$this->data['FranceMasterListing']['material_type1']));
echo $this->Form->input('material_type2',array('value'=>$this->data['FranceMasterListing']['material_type2']));
$error_by = '';
