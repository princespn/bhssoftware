<?php if($session->read('Auth.User.group_id')=='4' && $session->read('Auth.User.group_id')=='3')
{
...
$wordlist = split ("\_", $france_master_listing['FranceMasterListing']['item_sku']); 	
?>
<tr<?php echo $class;?>>
...
<td><?php if (!empty($france_master_listing['FranceProductListing']['category'])){ echo $france_master_listing['ProductListing']['category'];} ?></td>
...
<td><?php
	if((($wordlist[1])!=='FBA') && (empty($france_master_listing['FranceMasterListing']['item_name'])))
	{
