...
//echo $this->Form->input('product_code',array('readonly' => 'readonly','value'=>$this->data ['InventoryMaster']['product_code']));
...
if((empty($this->data['InventoryMaster']['item_name']))){echo $this->Form->input('item_name',array('value'=>$this->data['InventoryMaster']['item_name'],'id'=>'sessionNum','maxlength'=>'500','class' =>'warning'));}else{echo $this->Form->input('item_name',array('value'=>$this->data['InventoryMaster']['item_name'],'id'=>'sessionNum','maxlength'=>'500'));}
...
if((empty($this->data['InventoryMaster']['quantity']))){}else{echo $this->Form->input('quantity',array('value'=>$this->data['InventoryMaster']['quantity']));}
