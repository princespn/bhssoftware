...
<h1 class="sub-header"><?php __('Import Master listing');?></h1>
<hr>
 ...
 <div class="panel panel-info import-panel">
      ...
      <div class="panel-body">
       <?php echo $this->Form->create('InventoryMaster',array('action' => 'import','enctype'=>'multipart/form-data'));?>
          <div class="form-group">          
            <?php echo $this->Form->input('file', array('label'=>'Import listing','type'=>'file')); ?> 
          </div>
