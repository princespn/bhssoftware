...
<?php echo $this->Form->input('brand_name',array('value'=>$this->data['InventoryMaster']['brand_name']));
echo $this->Form->input('manufacturer',array('value'=>$this->data['InventoryMaster']['manufacturer']));
echo $this->Form->input('feed_product_type',array('value'=>$this->data['InventoryMaster']['feed_product_type']));
