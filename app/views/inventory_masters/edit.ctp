...
if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['item_name']))){echo $this->Form->input('item_name',array('value'=>$this->data['InventoryMaster']['item_name'],'id'=>'sessionNum','maxLength'=>'500','class' =>'warning'));}elseif(strlen($this->data['InventoryMaster']['item_name'])>'500'){echo $this->Form->input('item_name',array('value'=>$this->data['InventoryMaster']['item_name'],'id'=>'sessionNum','maxLength'=>'500','class' =>'warning'));}else{echo $this->Form->input('item_name',array('value'=>$this->data['InventoryMaster']['item_name'],'id'=>'sessionNum','maxLength'=>'500'));}
?><div class="text_errror">Number of chars: <span id="sessionNum_counter">500</span>&nbsp;&nbsp;&nbsp;<a href=""><?php echo "Title cheker"; ?></a></div>
<?php if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['brand_name']))){echo $this->Form->input('brand_name',array('value'=>$this->data['InventoryMaster']['brand_name'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('brand_name',array('value'=>$this->data['InventoryMaster']['brand_name'],'readonly'=>'readonly'));}
if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['manufacturer']))){echo $this->Form->input('manufacturer',array('value'=>$this->data['InventoryMaster']['manufacturer'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('manufacturer',array('value'=>$this->data['InventoryMaster']['manufacturer'],'readonly'=>'readonly'));}
if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['feed_product_type']))){echo $this->Form->input('feed_product_type',array('value'=>$this->data['InventoryMaster']['feed_product_type'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('feed_product_type',array('value'=>$this->data['InventoryMaster']['feed_product_type'],'readonly'=>'readonly'));}
echo $this->Form->input('part_number',array('value'=>$this->data['InventoryMaster']['part_number']));
if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['product_description']))){echo $this->Form->input('product_description',array('value'=>$this->data['InventoryMaster']['product_description'],'id'=>'sessiondesc','maxLength'=>'2000','class'=>'warning'));}elseif(strlen($this->data['InventoryMaster']['product_description'])>'2000'){echo $this->Form->input('product_description',array('value'=>$this->data['InventoryMaster']['product_description'],'id'=>'sessiondesc','maxLength'=>'2000','class'=>'warning'));}else{echo $this->Form->input('product_description',array('value'=>$this->data['InventoryMaster']['product_description'],'id'=>'sessiondesc','maxLength'=>'2000')); } ?><div class="text_errror">Number of chars: <span id="sessiondesc_counter">2000</span></div>
...
if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['quantity']))){}else{echo $this->Form->input('quantity',array('value'=>$this->data['InventoryMaster']['quantity']));}
