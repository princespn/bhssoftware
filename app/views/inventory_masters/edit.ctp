...
if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['item_name']))){echo $this->Form->input('item_name',array('value'=>$this->data['InventoryMaster']['item_name'],'id'=>'sessionNum','maxLength'=>'500','class' =>'warning'));}else{echo $this->Form->input('item_name',array('value'=>$this->data['InventoryMaster']['item_name'],'id'=>'sessionNum','maxLength'=>'500'));}
...
if((empty($this->data['InventoryMaster']['standard_price']))){echo $this->Form->input('standard_price',array('value'=>$this->data['InventoryMaster']['standard_price'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('standard_price',array('value'=>$this->data['InventoryMaster']['standard_price'],'readonly'=>'readonly'));}
...
if((empty($this->data['InventoryMaster']['sale_price']))){echo $this->Form->input('sale_price',array('value'=>$this->data['InventoryMaster']['sale_price'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('sale_price',array('value'=>$this->data['InventoryMaster']['sale_price'],'readonly'=>'readonly'));}
...
<?php if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['bullet_point2']))){echo $this->Form->input('bullet_point2',array('value'=>$this->data['InventoryMaster']['bullet_point2'],'id'=>'sessionbullet2','maxLength'=>'500','class' =>'warning'));}else{echo $this->Form->input('bullet_point2',array('value'=>$this->data['InventoryMaster']['bullet_point2'],'id'=>'sessionbullet2','maxLength'=>'500'));} ?><div class="text_errror">Number of chars: <span id="sessionbullet2_counter">500</span></div>
<?php if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['bullet_point3']))){echo $this->Form->input('bullet_point3',array('value'=>$this->data['InventoryMaster']['bullet_point3'],'id'=>'sessionbullet3','maxLength'=>'500','class' =>'warning'));}else{echo $this->Form->input('bullet_point3',array('value'=>$this->data['InventoryMaster']['bullet_point3'],'id'=>'sessionbullet3','maxLength'=>'500'));} ?><div class="text_errror">Number of chars: <span id="sessionbullet3_counter">500</span></div>
...
<?php if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['bullet_point5']))){echo $this->Form->input('bullet_point5',array('value'=>$this->data['InventoryMaster']['bullet_point5'],'id'=>'sessionbullet5','maxLength'=>'500','class' =>'warning'));}else{echo $this->Form->input('bullet_point5',array('value'=>$this->data['InventoryMaster']['bullet_point5'],'id'=>'sessionbullet5','maxLength'=>'500'));} ?><div class="text_errror">Number of chars: <span id="sessionbullet5_counter">500</span></div>
...
<?php if((($wordlist[1])!=='FBA') && (empty($this->data['InventoryMaster']['generic_keywords3']))){echo $this->Form->input('generic_keywords3',array('value'=>$this->data['InventoryMaster']['generic_keywords3'],'id'=>'sessiongen_key3','maxLength'=>'50','class' =>'warning'));}else{echo $this->Form->input('generic_keywords3',array('value'=>$this->data['InventoryMaster']['generic_keywords3'],'id'=>'sessiongen_key3','maxLength'=>'50'));} ?><div class="text_errror">Number of chars: <span id="sessiongen_counter3">50</span></div>
