...
<?php 
echo $this->Form->create('EnglishListing',array('action' => 'update','enctype'=>'multipart/form-data'));?>
<fieldset>
<legend><?php __('Update UK Listing'); ?></legend>
<?php
echo $this->Form->input('file', array('label'=>'Update UK listing','type'=>'file') );
