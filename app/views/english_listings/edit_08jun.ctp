...
if((empty($this->data['EnglishListing']['sale_price']))){echo $this->Form->input('sale_price',array('value'=>$this->data['EnglishListing']['sale_price'],'readonly'=>'readonly','class'=>'warning'));}else{echo $this->Form->input('sale_price',array('value'=>$this->data['EnglishListing']['sale_price'],'readonly'=>'readonly'));}
