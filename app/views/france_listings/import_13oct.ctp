...
<div class="grid_16">
<h2 id="page-heading"><?php __('Amazon France Database.');?></h2>
<?php echo $this->Form->create('FranceListing',array('action' => 'import','enctype'=>'multipart/form-data')); ?>
<fieldset>
<legend><?php __('Import France Amazon Listing'); ?></legend>
<?php
echo $this->Form->input('file', array('label'=>'Import France listing','type'=>'file') );
