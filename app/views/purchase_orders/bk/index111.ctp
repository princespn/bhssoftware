        ...
        <?php //if(($purchase_order['CostSetting']['sale_base_currency']==='GBP')){ ?>
         ...
         <?php } ?>
          ...
          <td><?php // Currency Master Information in GBP---                   
                  ...
                  //   echo "IV".$purchase_order['PurchaseOrder']['invoice_value'];
                   //  echo "SM".$purchase_order['SupplierMultiplier']['multiplier'];
                    // echo "IR".$exchange_rate['CostSetting']['exchange_rate'];
