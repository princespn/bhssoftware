          ...
          <th><ul class="select-drop">
              <li class="dropdown"><a aria-expanded="false" aria-haspopup="true" role="button" data-toggle="dropdown" class="dropdown-toggle" href="#">Category <span class="caret"></span></a>
                <ul class="dropdown-menu">
                    ...
                    <li><a href="<?php echo  $actual_link ; ?>/admin_listings/index/<?php echo rawurlencode($category->CategoryName); ?>" target="_self"><?php echo $category->CategoryName; ?></a></li>
                  <?php endforeach; ?>
                </ul>
              </li>
            </ul></th>
...
<?php foreach ($price_listings as $code_listing): ?>
       ...
       <?php foreach ($Amazonde as $deamazon): ?>
       <?php if(($code_listing['AdminListing']['linnworks_code']) === ($deamazon['MasterListing']['linnworks_code'])){  ?>  
       <?php  if ((strpos($deamazon['MasterListing']['amazon_sku'], 'FBA') === false) && (!empty($deamazon['MasterListing']['sale_price_de']))){?>
            <td><?php echo $deamazon['MasterListing']['sale_price_de'];  ?></td> 
         <?php break; } ?>
         <?php } ?>     
        <?php endforeach; ?>
         
             
       <?php foreach ($Amazonde as $amazondefba): ?>
       <?php if(($code_listing['AdminListing']['linnworks_code']) === ($amazondefba['MasterListing']['linnworks_code'])){  ?>  
       <?php  if ((strpos($amazondefba['MasterListing']['amazon_sku'], 'FBA') !== false) && (!empty($amazondefba['MasterListing']['sale_price_de']))){?>
             <td><?php echo $amazondefba['MasterListing']['sale_price_de']; ?></td>
        <?php break; } ?>
        <?php } ?>
        <?php endforeach; ?>
       ...
       <?php  if ((strpos($amazonfr['MasterListing']['amazon_sku'], 'FBA') === false) && (!empty($amazonfr['MasterListing']['sale_price_fr']))){?>
            <td><?php echo $amazonfr['MasterListing']['sale_price_fr'];  ?></td> 
           <?php break; } ?>
         <?php } ?>
        <?php endforeach; ?>
            
       <?php foreach ($Amazonfr as $amazonfrfba): ?>
       <?php if(($code_listing['AdminListing']['linnworks_code']) === ($amazonfrfba['MasterListing']['linnworks_code'])){  ?>  
        <?php  if ((strpos($amazonfrfba['MasterListing']['amazon_sku'], 'FBA') !== false) && (!empty($amazonfrfba['MasterListing']['sale_price_fr']))){?>
             <td><?php echo $amazonfrfba['MasterListing']['sale_price_fr']; ?></td>
        <?php break; } ?>
        <?php } ?>
        <?php endforeach; ?>         
        </tr>
