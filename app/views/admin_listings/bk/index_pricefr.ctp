...
<?php foreach ($price_listings as $code_listing): ?>
       ...
       <?php if(($code_listing['AdminListing']['linnworks_code']) === ($amazonprice['MasterListing']['linnworks_code'])){  ?>  
         ...
         <?php  if ((strpos($amazonprice['MasterListing']['amazon_sku'], 'FBA') === false) && (!empty($amazonprice['MasterListing']['sale_price_uk']))){?>
             <td><?php echo $amazonprice['MasterListing']['sale_price_uk']; ?></td>
            <?php } else {?>
             <td></td>
            <?php } ?>
            <?php break; } ?>
           <?php endforeach; ?>
             ...
             <?php foreach ($Amazonprices as $amazonpriceukfba): ?>
       <?php if(($code_listing['AdminListing']['linnworks_code']) === ($amazonpriceukfba['MasterListing']['linnworks_code'])){  ?>  
       
         <?php  if ((strpos($amazonpriceukfba['MasterListing']['amazon_sku'], 'FBA') !== false) && (!empty($amazonpriceukfba['MasterListing']['sale_price_uk']))){?>
             <td><?php echo $amazonpriceukfba['MasterListing']['sale_price_uk']; ?></td>
            <?php break; } ?>
             <?php } ?>
           <?php endforeach; ?>
       ...
       <?php foreach ($Amazonprices as $amazonpricefrfba): ?>
       <?php if(($code_listing['AdminListing']['linnworks_code']) === ($amazonpricefrfba['MasterListing']['linnworks_code'])){  ?>  
       <?php  if ((strpos($amazonpricefrfba['MasterListing']['amazon_sku'], 'FBA') === false) && ($amazonpricefrfba['MasterListing']['sale_price_fr'])){?>
            <td><?php echo $amazonpricefrfba['MasterListing']['sale_price_fr'];  ?></td> 
            <?php break; } ?>
             <?php } ?>
           <?php endforeach; ?>
