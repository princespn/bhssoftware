...
<h1 class="sub-header"><?php __('Master Website Prices Inventory');?></h1>
<hr>

 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Master Website Prices Inventory');?></h3>
      </div>
      <div class="panel-body">
        <?php echo $this->Form->create('AdminListing',array('action' => 'importcode','enctype'=>'multipart/form-data'));?>
          <div class="form-group">          
            <?php echo $this->Form->input('file', array('label'=>'Import Inventory','type'=>'file') );?> 
          </div>
      <?php echo $this->Form->button('Import Inventory', array('id'=>'submit','class'=>'btn btn-primary btn-sm','disabled'=>'disabled','type'=>'submit'));
...
$(document).ready(function(){
	$('#AdminListingFile').change(function(){
