...
$suppname = array($stockall_report['StockItem']['supp_name']);
			...
			$aveg_of_aveg = array('0.00'); $lastmonthtotalqty = array('0.00'); 
		...
		$aveg_of_aveg[0] = ($Average_12month[0]+$Average_six_month[0]+$Average_3month[0])/3; 
		  ...
		  foreach($Cuurentstocks as $Cuurentstock):
			...
			$stock_availability[0] = ($currentstock[0]/$aveg_of_aveg[0]);
...
$line = array_merge($sku, $desc,$catname,$suppname,$totalqty,$Amaxname,$Amaxvalue,$Aminname,$Aminvalue,$nomberdays,$Average_12month,$totalsell,$days_six,$Average_six_month,$totalsell_3month,$days_3month,$Average_3month,$lastmonthtotalqty,$aveg_of_aveg,$currentstock,$duestock,$stock_availability,$minimumlevel);
