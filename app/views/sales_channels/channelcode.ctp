...
<h1 class="sub-header"><?php __('Import Linnworks Channel Codes');?></h1>
<hr>

 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Linnworks Channel Codes listing');?></h3>
      </div>
      <div class="panel-body">
       <?php echo $this->Form->create('SalesChannel',array('action' => 'channelcode','enctype'=>'multipart/form-data'));?>
          <div class="form-group">          
            <?php echo $this->Form->input('file', array('label'=>'Import codes','type'=>'file')); ?> 
          </div>
...
$(document).ready(function(){
	$('#SalesChannelFile').change(function(){
