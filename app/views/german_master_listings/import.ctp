...
<h1 class="sub-header"><?php __('Import Master Amazon DE Database');?></h1>
<hr>
 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Master Amazon DE Listing');?></h3>
      </div>
      <div class="panel-body">
       <?php echo $this->Form->create('GermanMasterListing',array('action' => 'import','enctype'=>'multipart/form-data'));?>
          <div class="form-group">          
            <?php echo $this->Form->input('file', array('label'=>'Import Amazon DE Listing','type'=>'file')); ?> 
          </div>
