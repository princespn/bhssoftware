...
<h1 class="sub-header"><?php __('Import Linnworks Codes');?></h1>
<hr>

 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __(' Linnworks Codes listing');?></h3>
      </div>
      <div class="panel-body">
       <?php echo $this->Form->create('InventoryCode',array('action' => 'linnworkcode','enctype'=>'multipart/form-data'));?>
...
$(document).ready(function(){
	$('#InventoryCodeFile').change(function(){
