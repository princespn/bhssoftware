...
$line_ams = array($code_listing['MainListing']['channel_sku']);
...
<?php foreach ($code_listings as $code_listing): ?>
        <tr>
            ...
            <?php  if((!empty($code_listing['MainListing']['price_uk'])) && ($code_listing['MainListing']['channel_id']=='1')) { ?>
         ...
         <?php } else if(!empty($code_listing['Listing']['web_sale_price_uk'])) { ?>
          ...
          <td><?php  echo $code_listing['Listing']['web_sale_price_tesco']; ?></td>
           <?php } else { ?><td><?php echo 'NA';?></td><?php } ?>
            ...
            <?php if((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && ((!empty($code_listing['MainListing']['sale_price_uk'])) && (!empty($code_listing['AdminListing']['web_sale_price_uk']))) && ((($code_listing['MainListing']['channel_id']) === '1') && ($code_listing['MainListing']['sale_price_uk']) !==($code_listing['AdminListing']['web_sale_price_uk']))){  ?>
            ...
            <?php  } else if ((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && (!empty($code_listing['MainListing']['sale_price_uk']))){?>        
            ...
            <?php //if((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && ((!empty($code_listing['MainListing']['channel_sale_price'])) && (!empty($code_listing['AdminListing']['web_sale_price_uk']))) && (($code_listing['MainListing']['sale_price_uk']) !==($code_listing['AdminListing']['web_sale_price_uk']))){  ?>
            <?php if((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && (!empty($code_listing['MainListing']['sale_price_uk']))){  ?>
            <td><?php  echo "sscv". $code_listing['MainListing']['sale_price_uk']; ?></td>       
            <?php } else { ?>
            <td><?php echo 'NA';?></td>
            <?php } ?>

           <?php if((strpos($code_listing['MainListing']['channel_sku'], 'FBA') !== false) && ((!empty($code_listing['MainListing']['sale_price_uk'])) && (!empty($code_listing['Listing']['web_sale_price_dm']))) && (($code_listing['MainListing']['sale_price_uk']) !==($code_listing['Listing']['web_sale_price_dm']))){  ?>
           ...
           <td><?php echo $code_listing['Listing']['web_sale_price_dm']; ?></td>                      
            ...
            <?php  if((!empty($code_listing['MainListing']['price_de'])) && ($code_listing['MainListing']['channel_id']=='3')){  ?>         
            <td  class="pink-price"><?php  echo $code_listing['MainListing']['price_de']; ?></td>
            <?php } else if((!empty($code_listing['MainListing']['price_fr'])) && ($code_listing['MainListing']['channel_id']=='2')){  ?>
            <td  class="pink-price"><?php  echo $code_listing['MainListing']['price_fr']; ?></td>
            <?php } else { ?>
           ...
           <?php if((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && ((!empty($code_listing['MainListing']['sale_price_de'])) && (!empty($code_listing['AdminListing']['web_sale_price_de']))) && ((($code_listing['MainListing']['channel_id']) === '3') && ($code_listing['MainListing']['sale_price_de']) !==($code_listing['AdminListing']['web_sale_price_de']))){  ?>
            ...
            <?php  } else if ((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && (!empty($code_listing['MainListing']['sale_price_de']))){?>        
            ...
            <?php //if((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && ((!empty($code_listing['MainListing']['channel_sale_price'])) && (!empty($code_listing['AdminListing']['web_sale_price_uk']))) && (($code_listing['MainListing']['sale_price_uk']) !==($code_listing['AdminListing']['web_sale_price_uk']))){  ?>
            <?php if(((strpos($code_listing['MainListing']['channel_sku'], 'FBA') !== false) && (!empty($code_listing['MainListing']['channel_sale_price'])))  && (($code_listing['MainListing']['channel_id']) === '3')){  ?>
            <td><?php  echo $code_listing['MainListing']['channel_sale_price']; ?></td>       
            <?php } else { ?>
            <td><?php echo 'NA';?></td>
            <?php } ?>
           ...
           <?php if(((!empty($code_listing['Listing']['web_sale_price_fr'])) && (!empty($code_listing['AdminListing']['web_sale_price_fr']))) && (($code_listing['Listing']['web_sale_price_fr']) !==($code_listing['AdminListing']['web_sale_price_fr']))){  ?>
            ...
            <?php } ?> 
             ...
             <?php if((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && ((!empty($code_listing['MainListing']['sale_price_fr'])) && (!empty($code_listing['AdminListing']['web_sale_price_fr']))) && (($code_listing['MainListing']['sale_price_fr']) !==($code_listing['AdminListing']['web_sale_price_fr']))){  ?>
            ...
            <?php  } else if ((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && (!empty($code_listing['MainListing']['sale_price_fr']))){?>        
            ...
            <?php //if((strpos($code_listing['MainListing']['channel_sku'], 'FBA') === false) && ((!empty($code_listing['MainListing']['channel_sale_price'])) && (!empty($code_listing['AdminListing']['web_sale_price_uk']))) && (($code_listing['MainListing']['sale_price_uk']) !==($code_listing['AdminListing']['web_sale_price_uk']))){  ?>
            <?php if(((strpos($code_listing['MainListing']['channel_sku'], 'FBA') !== false) && (!empty($code_listing['MainListing']['sale_price_fr'])))  && (($code_listing['MainListing']['channel_id']) === '2')){  ?>
            <td><?php  echo $code_listing['MainListing']['sale_price_fr']; ?></td>       
            <?php } else { ?>
            <td><?php echo 'NA';?></td>
            <?php } ?>
