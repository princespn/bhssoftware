...
<h1 class="sub-header"><?php __('Processed Orders Import CSV in Database System');?></h1>
<hr>

 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Import CSV in Database System');?></h3>
      </div>
      <div class="panel-body">
        <?php echo $this->Form->create('ProcessedOrder',array('action' => 'importprocessed','enctype'=>'multipart/form-data'));?>
...
$(document).ready(function(){
	$('#ProcessedOrderFile').change(function(){
