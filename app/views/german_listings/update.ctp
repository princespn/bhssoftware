...
<?php 
echo $this->Form->create('GermanListing',array('action' => 'update','enctype'=>'multipart/form-data'));?>
	<fieldset>
		<legend><?php __('Update Germany Listing'); ?></legend>
		<?php
		echo $this->Form->input('file', array('label'=>'Update Germany listing','type'=>'file') );
	...
	<div class='submit'>
<?php 
echo $this->Form->button('Update Listingisting', array('id'=>'submit','disabled'=>'disabled','type'=>'submit'));
echo "&nbsp;&nbsp;&nbsp;&nbsp;";
