    ...
    var $helpers = array('Html', 'Form', 'Ajax', 'Javascript', 'Js', 'Csv');
		...
		public function categname() {
			...
			public function searchpurorder($pagenum){				
						...
						$url ='https://eu-ext.linnworks.net//api/PurchaseOrder/Search_PurchaseOrders?searchParameter={"DateFrom":"2018-04-11T00:00:00","DateTo":"2018-08-08T00:00:00","Status":"DELIVERED","EntriesPerPage":02,"PageNumber":'. $pagenum .'}';
