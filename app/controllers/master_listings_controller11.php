...
class MasterListingsController extends AppController {
    ...
    public function index() {
        ...
        $Amazonuk   =	$this->MasterListing->find('all',array('fields' => array('MasterListing.sale_price_uk','MasterListing.linnworks_code','MasterListing.id'), 'conditions' => array('MasterListing.channel_id' =>'1')));
        //print_r($Amazonuk);
        $France_primes   =	$this->MasterListing->find('all',array('fields' => array('MasterListing.sale_price_fr','MasterListing.linnworks_code','MasterListing.id'), 'conditions' => array('MasterListing.channel_id' =>'2')));
      
        $Germany_primes   =	$this->MasterListing->find('all',array('fields' => array('MasterListing.sale_price_de','MasterListing.linnworks_code','MasterListing.id'), 'conditions' => array('MasterListing.channel_id' =>'3')));
        $this->set(compact('Amazonuk','getshipppings','France_primes','Germany_primes'));
    ...
    public function index_prices() {
        ...
        if ((!empty($this->data)) && (!empty($_POST['submit'])) && (!empty($this->data['MasterListing']['all_item']))) {
            ...
            $this->MasterListing->recursive = 1;
            $this->paginate = array('limit' => 500, 'order' => 'MasterListing.channel_sku');
