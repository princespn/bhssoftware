...
class StockCurrentsController extends AppController {
	
    var $name = 'StockCurrents';
    ...
    public function categname() {
		...
		public function index(){					
				...
				if (!empty($orders)) {
					...
					if((!empty($order->CategoryName)) && (($order->CategoryName !=='SAMPLES') && ($order->CategoryName !=='Swatches'))){
