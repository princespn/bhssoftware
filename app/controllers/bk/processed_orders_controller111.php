...
class ProcessedOrdersController extends AppController {
    ...
    public function getallprocess($pagenum){
		...
		//$from = '2018-06-21T00:00:00'; //min
		$from = '';   // 2017-04-03 - TO - 2017-04-09
		//$to =  '2018-07-10T60:60:60'; //max
		$to = '';
