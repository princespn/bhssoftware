...
--
-- Host: localhost:3306
-- Generation Time: Aug 13, 2018 at 11:36 PM
...
CREATE TABLE `main_listings` (
  ...
  `linnworks_code` varchar(400) NOT NULL,
...
--
-- Table structure for table `stock_currents`
--

CREATE TABLE `stock_currents` (
  `id` int(11) NOT NULL,
  ...
  `minimum_level` varchar(100) DEFAULT NULL,
  `due_level` varchar(100) DEFAULT NULL,
...
ALTER TABLE `cost_calculators`
  ...
  ADD KEY `linnworks_code_2` (`linnworks_code`);
...
ALTER TABLE `main_listings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `index_name` (`amazon_sku`,`channel_id`,`linnworks_code`) USING BTREE;
...
ALTER TABLE `processed_listings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniqecolumn` (`order_id`(200),`product_sku`(200)) USING BTREE;
...
ALTER TABLE `purchase_prices`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `item_sku` (`item_sku`) USING BTREE;
...
--
-- Indexes for table `stock_currents`
--
ALTER TABLE `stock_currents`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniqitems` (`change_date`,`item_number`,`stock_location_id`) USING BTREE;
...
ALTER TABLE `stock_levels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `uniqe` (`item_number`,`item_title`,`barcode_number`,`category_name`,`location_name`,`change_date`) USING BTREE;
...
--
ALTER TABLE `admin_listings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9405;
--
...
--
ALTER TABLE `main_listings`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24825;
--
...
--
ALTER TABLE `processed_listings`
  MODIFY `id` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1131108;
--
-- AUTO_INCREMENT for table `processed_orders`
--
ALTER TABLE `processed_orders`
  MODIFY `id` bigint(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1182007;
--
...
--
ALTER TABLE `purchase_prices`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6688;
--
...
--
-- AUTO_INCREMENT for table `stock_currents`
--
ALTER TABLE `stock_currents`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1897071;
--
...
--
ALTER TABLE `stock_levels`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15315652;
--
