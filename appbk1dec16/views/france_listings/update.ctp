...
<h1 class="sub-header"><?php __('Amazon France Database.');?></h1>
<hr>
 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Update France Amazon Listing Database.');?></h3>
      </div>
      <div class="panel-body">
       <?php echo $this->Form->create('FranceListing',array('action' => 'update','enctype'=>'multipart/form-data')); ?>    <div class="form-group"> 
           <?php echo $this->Form->input('file', array('label'=>'Update France listing','type'=>'file') ); ?>
