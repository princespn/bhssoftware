...
<div class="grid_16">
<h2 id="page-heading"><?php __('Import DE Product Code Inventory');?></h2>
<?php 
echo $this->Form->create('GermanProductListing',array('action' => 'importcode','enctype'=>'multipart/form-data'));?>
<fieldset>
<legend><?php __('Import german product code'); ?></legend>
