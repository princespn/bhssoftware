...
<div class="row">
		<div class="col-sm-4 col-md-6 col-md-offset-6">
			<table class="table-responsive table-striped text-center table table-bordered">
				<tr>				
				 ...
				 <?php foreach ($exchange_rates as $exchange_rate): ?>
                                    ...
                                    <td><?php       $amount = "1"; $from = $exchange_rate['PurchaseOrder']['sale_base_currency']; $to =  $exchange_rate['PurchaseOrder']['invoice_currency'];
