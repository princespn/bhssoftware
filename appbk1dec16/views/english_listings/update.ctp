...
<h1 class="sub-header"><?php __('Update  Amazon UK Database');?></h1>
<hr>
 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Update Amazon UK Listing');?></h3>
      </div>
      <div class="panel-body">
       <?php echo $this->Form->create('EnglishListing',array('action' => 'update','enctype'=>'multipart/form-data'));?>
          <div class="form-group">          
            <?php echo $this->Form->input('file', array('label'=>'Update Amazon UK Listing','type'=>'file')); ?> 
          </div>
