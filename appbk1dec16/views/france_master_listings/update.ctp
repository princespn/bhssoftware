...
<h1 class="sub-header"><?php __('Update FR Masters Database');?></h1>
<hr>
 ...
 <div class="panel panel-info import-panel">
      ...
      <div class="panel-body">
       <?php echo $this->Form->create('FranceMasterListing',array('action' => 'update','enctype'=>'multipart/form-data'));?>
          <div class="form-group">          
            <?php echo $this->Form->input('file', array('label'=>'Update FR Master Listing','type'=>'file')); ?> 
          </div>
