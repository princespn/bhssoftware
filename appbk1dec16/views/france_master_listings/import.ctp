...
<h1 class="sub-header"><?php __('Import Master Amazon France Database');?></h1>
<hr>
 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Master Amazon France Listing');?></h3>
      </div>
      <div class="panel-body">
       <?php echo $this->Form->create('FranceMasterListing',array('action' => 'import','enctype'=>'multipart/form-data'));?>
          <div class="form-group">          
            <?php echo $this->Form->input('file', array('label'=>'Import Amazon FR Listing','type'=>'file')); ?> 
          </div>
