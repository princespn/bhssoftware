...
<?php  echo $form->create('FranceProductListing',array('action'=>'index','id'=>'saveForm')); ?>
 <h1 class="sub-header"><?php __('FR Product Code Database.');?></h1>
  <div class="panel panel-default">
    <div class="panel-body">
      <div class="row">
        <div class="col-md-8 mobile-bottomspace">
         <?php echo $this->Html->link(__('Import Prices', true), array('controller' => 'france_product_listings', 'action' => 'importcode'),array('class' => 'btn btn-info btn-sm')); ?>
  ...
  <div class="table-responsive">
    <table class="table table-bordered table-striped table-hover">
      ...
      <tbody>
     <?php foreach ($france_product_listings as $france_product_listing): ?>
        <tr>         
          <td><?php $productid = $france_product_listing['FranceProductListing']['id']; echo $this->Form->input('FranceProductListing.id',array('class'=>'checkbox1', 'selected'=>'selected','label'=>'','multiple' => 'checkbox', 'value' =>$productid,'name'=>'checkid[]', 'type'=>'checkbox')); ?></td>
