...
<h1 class="sub-header"><?php __('Import FR Product Code Inventory');?></h1>
<hr>

 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Product Code Inventory');?></h3>
      </div>
      <div class="panel-body">
       <?php echo $this->Form->create('FranceProductListing',array('action' => 'importcode','enctype'=>'multipart/form-data'));?>
