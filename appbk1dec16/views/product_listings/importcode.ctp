...
<h1 class="sub-header"><?php __('UK Product Code Inventory');?></h1>
<hr>

 <div class="panel panel-info import-panel">
      <div class="panel-heading">
        <h3 class="panel-title"><?php __('Import UK Product Code Inventory');?></h3>
      </div>
      <div class="panel-body">
       <?php echo $this->Form->create('ProductListing',array('action' => 'importcode','enctype'=>'multipart/form-data'));?>
