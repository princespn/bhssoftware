...
class PurchaseOrdersController extends AppController {
	...
	var $name = 'PurchaseOrders';
        ...
        public function beforeFilter() {
                ...
                parent::beforeFilter();
                $this->Auth->allow(array( 'category','getsupp','edit','index','importdata','settings','categories','suppliers'));
    ...
    public function index() {
        ...
        */
            ...
            $this->PurchaseOrder->recursive = 1;
            $this->paginate = array('limit' => 1000, 'group' => 'PurchaseOrder.exchange_rate');
   ...
   public function categories(){
    ...
    public function suppliers(){
     ...
     public function settings(){
            ...
            $this->PurchaseOrder->recursive = 1;
            $this->paginate = array('limit' => 1000, 'group' => 'PurchaseOrder.category');
            $this->set('supplier_orders', $this->paginate());
            $this->set(compact('categories','suppname'));
