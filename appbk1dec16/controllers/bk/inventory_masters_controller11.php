...
class InventoryMastersController extends AppController {
    ...
    function view($id = null) {
        if (!$id) {
            $this->Session->setFlash(__('Invalid The Master Listing Id.', true));
            $this->redirect(array('action' => 'index'));
        }
        $this->set('inventory_masters', $this->InventoryMaster->read(null, $id));
    }
    ...
    function add($id = null) {
        if (!empty($this->data)) {
            ...
            if ($this->InventoryMaster->save($this->data['InventoryMaster'])) {
                $this->Session->setFlash(__('The Master Listing was created successfully.', true));
                $this->redirect(array('action' => 'index'));
            } else {
