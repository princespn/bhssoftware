...
--
-- Host: localhost:3306
-- Generation Time: May 17, 2017 at 05:33 AM
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8050 ;
...
CREATE TABLE IF NOT EXISTS `france_master_listings` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `item_sku` (`item_sku`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6589 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5757 ;
...
CREATE TABLE IF NOT EXISTS `inventory_masters` (
  ...
  UNIQUE KEY `item_sku` (`item_sku`),
  KEY `item_sku_2` (`item_sku`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=11605 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=18799 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=39500 ;
...
CREATE TABLE IF NOT EXISTS `open_orders` (
  ...
  `product_sku` varchar(600) NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `processed_listings` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `key_unique` (`order_id`(13),`product_sku`(14),`product_name`(15),`price_per_product`(17))
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=645190 ;
...
CREATE TABLE IF NOT EXISTS `processed_orders` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `order_number` (`order_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=557241 ;
...
CREATE TABLE IF NOT EXISTS `purchase_orders` (
  ...
  UNIQUE KEY `linnworks_code` (`linnworks_code`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=24424 ;
