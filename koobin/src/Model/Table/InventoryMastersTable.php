 ...
 *
 * @method \App\Model\Entity\InventoryMaster get($primaryKey, $options = [])
 * @method \App\Model\Entity\InventoryMaster newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\InventoryMaster[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\InventoryMaster|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\InventoryMaster patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\InventoryMaster[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\InventoryMaster findOrCreate($search, callable $callback = null, $options = [])
 */
class InventoryMastersTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setTable('inventory_masters');
