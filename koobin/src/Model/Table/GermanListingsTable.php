 ...
 *
 * @method \App\Model\Entity\GermanListing get($primaryKey, $options = [])
 * @method \App\Model\Entity\GermanListing newEntity($data = null, array $options = [])
 * @method \App\Model\Entity\GermanListing[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\GermanListing|bool save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\GermanListing patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\GermanListing[] patchEntities($entities, array $data, array $options = [])
 * @method \App\Model\Entity\GermanListing findOrCreate($search, callable $callback = null, $options = [])
 */
class GermanListingsTable extends Table
{
