...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $englishListing->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $englishListing->id)]
            )
        ?></li>
...
<div class="englishListings form large-9 medium-8 columns content">
    <?= $this->Form->create($englishListing) ?>
    <fieldset>
        <legend><?= __('Edit English Listing') ?></legend>
        <?php
