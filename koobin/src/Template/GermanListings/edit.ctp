...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $germanListing->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $germanListing->id)]
            )
        ?></li>
...
<div class="germanListings form large-9 medium-8 columns content">
    <?= $this->Form->create($germanListing) ?>
    <fieldset>
        <legend><?= __('Edit German Listing') ?></legend>
        <?php
