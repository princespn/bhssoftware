...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $franceMasterListing->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $franceMasterListing->id)]
            )
        ?></li>
...
<div class="franceMasterListings form large-9 medium-8 columns content">
    <?= $this->Form->create($franceMasterListing) ?>
    <fieldset>
        <legend><?= __('Edit France Master Listing') ?></legend>
        <?php
