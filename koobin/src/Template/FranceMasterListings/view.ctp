 ...
 * @var \App\Model\Entity\FranceMasterListing $franceMasterListing
 */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Actions') ?></li>
        <li><?= $this->Html->link(__('Edit France Master Listing'), ['action' => 'edit', $franceMasterListing->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete France Master Listing'), ['action' => 'delete', $franceMasterListing->id], ['confirm' => __('Are you sure you want to delete # {0}?', $franceMasterListing->id)]) ?> </li>
        <li><?= $this->Html->link(__('List France Master Listings'), ['action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New France Master Listing'), ['action' => 'add']) ?> </li>
        <li><?= $this->Html->link(__('List Users'), ['controller' => 'Users', 'action' => 'index']) ?> </li>
        <li><?= $this->Html->link(__('New User'), ['controller' => 'Users', 'action' => 'add']) ?> </li>
    </ul>
</nav>
<div class="franceMasterListings view large-9 medium-8 columns content">
    <h3><?= h($franceMasterListing->id) ?></h3>
    ...
    <div class="row">
        ...
        <?= $this->Text->autoParagraph(h($franceMasterListing->product_description)); ?>
    </div>
    <div class="row">
        <h4><?= __('Bullet Point1') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->bullet_point1)); ?>
    </div>
    <div class="row">
        <h4><?= __('Bullet Point2') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->bullet_point2)); ?>
    </div>
    <div class="row">
        <h4><?= __('Bullet Point3') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->bullet_point3)); ?>
    </div>
    <div class="row">
        <h4><?= __('Bullet Point4') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->bullet_point4)); ?>
    </div>
    <div class="row">
        <h4><?= __('Bullet Point5') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->bullet_point5)); ?>
    </div>
    <div class="row">
        <h4><?= __('Generic Keywords1') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->generic_keywords1)); ?>
    </div>
    <div class="row">
        <h4><?= __('Generic Keywords2') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->generic_keywords2)); ?>
    </div>
    <div class="row">
        <h4><?= __('Generic Keywords3') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->generic_keywords3)); ?>
    </div>
    <div class="row">
        <h4><?= __('Generic Keywords4') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->generic_keywords4)); ?>
    </div>
    <div class="row">
        <h4><?= __('Generic Keywords5') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->generic_keywords5)); ?>
    </div>
    <div class="row">
        <h4><?= __('Platinum Keywords1') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->platinum_keywords1)); ?>
    </div>
    <div class="row">
        <h4><?= __('Platinum Keywords2') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->platinum_keywords2)); ?>
    </div>
    <div class="row">
        <h4><?= __('Platinum Keywords3') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->platinum_keywords3)); ?>
    </div>
    <div class="row">
        <h4><?= __('Platinum Keywords4') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->platinum_keywords4)); ?>
    </div>
    <div class="row">
        <h4><?= __('Platinum Keywords5') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->platinum_keywords5)); ?>
    </div>
    <div class="row">
        <h4><?= __('Target Audience Keywords1') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->target_audience_keywords1)); ?>
    </div>
    <div class="row">
        <h4><?= __('Target Audience Keywords2') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->target_audience_keywords2)); ?>
    </div>
    <div class="row">
        <h4><?= __('Target Audience Keywords3') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->target_audience_keywords3)); ?>
    </div>
    <div class="row">
        <h4><?= __('Target Audience Keywords4') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->target_audience_keywords4)); ?>
    </div>
    <div class="row">
        <h4><?= __('Target Audience Keywords5') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->target_audience_keywords5)); ?>
    </div>
    <div class="row">
        <h4><?= __('Error') ?></h4>
        <?= $this->Text->autoParagraph(h($franceMasterListing->error)); ?>
    </div>
</div>
