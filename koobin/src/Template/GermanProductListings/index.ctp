 ...
 * @var \App\Model\Entity\GermanProductListing[]|\Cake\Collection\CollectionInterface $germanProductListings
 */
?>
...
<div class="germanProductListings index large-9 medium-8 columns content">
    <h3><?= __('German Product Listings') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($germanProductListings as $germanProductListing): ?>
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $germanProductListing->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $germanProductListing->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $germanProductListing->id], ['confirm' => __('Are you sure you want to delete # {0}?', $germanProductListing->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
